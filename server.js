...
// ៣. API សម្រាប់សមាជិកចុះឈ្មោះ និងផ្ទៀងផ្ទាត់ (បន្ថែមប្រព័ន្ធលុបគណនីចាស់ស្វ័យប្រវត្ត)
app.post('/api/register', async (req, res) => {
    const { accId, password_mt5, server, platform, lotSize, sl_usd, tp_usd } = req.body;
    
    try {
        // --- ដំណោះស្រាយពិសេស៖ រត់ទៅលុបគណនីចាស់ៗចោលទាំងអស់មុនបង្កើតថ្មី ដើម្បីកុំឱ្យស្ទះកូតា Free Tier ---
